    ...
    <footer className="bg-slate-900 text-slate-300">
        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-4">
            ...
            <p className="text-sm leading-6 text-slate-400">
              A moderated marketplace for trusted Nigerian listings.
              Buy, sell, discover verified sellers, and grow visibility safely.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-semibold uppercase tracking-wider text-slate-100">Policies</h3>
            <ul className="space-y-2 text-sm text-slate-400">
              ...
              <li className="flex items-start gap-2">
                <ShieldCheck size={14} className="mt-0.5 shrink-0 text-brand-400" />
                All listings are moderated before they go live.
              </li>
              <li className="flex items-start gap-2">
                <ShieldCheck size={14} className="mt-0.5 shrink-0 text-brand-400" />
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <a href="mailto:peezutech@gmail.com" className="flex items-center gap-2 text-slate-400 transition hover:text-white">
                  <Mail size={14} className="text-brand-400" />
                  peezutech@gmail.com
                </a>
              </li>
              <li>
                <a href="https://peezutech.name.ng" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-slate-400 transition hover:text-white">
      ...
      <div className="border-t border-slate-700">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-2 px-4 py-4 text-xs text-slate-500 sm:flex-row">
          <p>© {year} PeezuHub — Moderated Nigerian Listings Marketplace. All rights reserved.</p>
